...
/**
 * A class that "bombards" an object by calling it many times, from multiple threads. Used for stress-testing synchronisation.
 *
 * @author nat // @version 1.0
 * @author Praveen Sivasamy //@version 2.0
 * @version 2.0
 * @see <a href="https://github.com/npryce/goos-code-examples/blob/master/testing-multithreaded-code/src/book/example/threading/races/">Gihub Example
