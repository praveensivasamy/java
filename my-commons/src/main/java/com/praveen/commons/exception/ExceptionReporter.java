...
public class ExceptionReporter extends RuntimeException {
    ...
    public static MyCommonsException instance(ExceptionIdentifier identifier) {
	return new MyCommonsException(identifier);
    }
     ...
     * @return
     */
    public static MyCommonsException instance(ExceptionIdentifier identifier, Exception cause) {
	MyCommonsException res = new MyCommonsException(cause);
     ...
     */
    protected ExceptionReporter(String errorMessage, Throwable causedException) {
     ...
     * @param causedException
     */
    protected ExceptionReporter(Throwable causedException) {
	super(causedException);
    }
     ...
     * @param errMsg
     */
    protected ExceptionReporter(String errMsg) {
     ...
     * @param identifier
     */
    protected ExceptionReporter(ExceptionIdentifier identifier) {
     ...
     * @return
     */
    public MyCommonsException step(String step) {
	setStep(step);
	return this;
    }
     ...
     * @return
     */
    public MyCommonsException details(Object value) {
