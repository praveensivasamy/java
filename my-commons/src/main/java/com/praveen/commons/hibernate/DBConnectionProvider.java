 ...
 * <p>
 * Creation of connection object is done by the Hibernate base class
 * {@link DriverManagerConnectionProviderImpl}
 *
 * @author Praveen
 *
 */
public class DBConnectionProvider extends DriverManagerConnectionProviderImpl {
	...
	public Connection getConnection() throws SQLException {
		...
		if (conn == null) {
			...
			log.info("Building new physical connection for user {}  by thread {}", conn.getMetaData().getUserName(),
	...
	public static void logStat() {
		log.info(
				"Total JDBC Connection requests: {} ; Total requests served from cache: {} ; Total new connections made : {} ",
