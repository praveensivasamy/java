...
public class ToStringUtils {
	 ...
	 *
	 * @param o              the object
	 * @param attributeNames the list of attribute names to be part of the output.
	 *                       If the attribute name ends with 'newLine', the
	 *                       attribute will be displayed on a new line
	...
	public static String asString(Object o, String... attributeNames) {
		...
		for (String attributeName : attributeNames) {
			...
			res.append("[").append(attributeName).append(":")
					.append(objectToString(ReflectionHelper.getFieldValue(attributeName, o))).append("]");
		}
		return res.toString();
	}
	...
	/**
	 * Replace the placeholder (which is enclosed in curly brackets) with the given
	 * value, optionally quoted with the single quote character
	 * <p>
