...
/**
 * Executes {@link Pipeline}s either in serial or parallel depending on the
 * threadsize
 *
...
public class PipelineExecutor {
	...
	/**
	 * Custom implementation ThreadFactory to ensure the pipelines are executed by
	 * same threads who created them
	 */
	...
	private void initializePipelines() {
		...
		for (Pipeline pipeline : pipelines) {
			executor.execute(() -> {
				log.info("Initialising pipeline {} in the thread {}", pipeline.getId(),
